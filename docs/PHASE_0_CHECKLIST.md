...
- [x] Beschikbare repositorysnapshot en publieke hosting auditen; production source/access ontbreekt.
- [x] Technische voorkeursfoundation vastleggen; exacte versies volgen na source recovery.
...
### Stap 5 — Repository recovery in parallel

Herstel en audit de canonieke GitHub/Vercel-bron vóór enige engineeringinitialisatie.
