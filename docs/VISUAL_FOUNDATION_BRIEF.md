...
WCAG 2.2 AA, 200% zoom, 320 px width, high contrast/forced colors review, color-independent states, touch targets, legible diagram labels, text alternatives, reduced transparency where needed, and no background detail behind critical text without a solid surface. Motion constraints live in `MOTION_FEASIBILITY.md`.
