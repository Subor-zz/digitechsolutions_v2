...
Every externally visible factual or promissory statement has one record in `CLAIM_REGISTER.md`. Identity/positioning decisions may be approved internally; experience, credentials, results, security and commercial promises require external or operational evidence. Unknown evidence means **do not publish**, not “probably true”.
