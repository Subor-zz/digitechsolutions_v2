...
const title =
  "ZZP Applicatiebeheerder & Functioneel Beheerder | Digitech Solutions";
const description =
  "Ervaren ZZP applicatiebeheerder en functioneel beheerder voor stabiele IT-omgevingen. Inzetbaar voor incident- en change management, support & ITSM.";
...
const organizationSchema = {
  ...
  description:
    "ZZP applicatiebeheerder en functioneel beheerder voor stabiele IT-omgevingen. Inzetbaar voor incident- en change management, support & ITSM.",
...
const localBusinessSchema = {
  ...
  image: `${siteUrl}/logo.png`,
  description:
    "ZZP applicatiebeheerder en functioneel beheerder in Breda. Stabiele IT-omgevingen, support en procesoptimalisatie.",
  telephone: "+31643983420",
  priceRange: "€€",
  address: {
    "@type": "PostalAddress",
...
const personSchema = {
  ...
  description:
    "ZZP applicatiebeheerder en functioneel beheerder met 9+ jaar ervaring in IT-beheer, support & ITSM.",
  knowsAbout: [
    "Applicatiebeheer",
    "Functioneel Beheer",
  ...
  itemListElement: [
    {
      ...
      description:
        "Incident- en change management, monitoring, releases en gebruikersbeheer voor stabiele applicaties.",
    ...
    },
    {
      ...
      description:
        "Requirements, wijzigingsbeheer, UAT, communicatie en procesoptimalisatie als brug tussen business en IT.",
    ...
    },
    {
      ...
      description:
        "1e/2e lijns support, ITIL-processen, SLA's, ticketing en serviceverbetering.",
    ...
    },
    {
      ...
      description:
        "Webapplicaties, API's en automatisering met moderne stack als aanvullende expertise.",
    ...
    },
    {
      ...
      description:
        "Projectplanning, stakeholdermanagement, releases en delivery van IT-projecten.",
    ...
    },
    {
      ...
      description:
        "Haalbaarheidsanalyse, scope-bepaling, risico-inventarisatie en technische review van productideeën.",
...
export default function RootLayout({
  ...
  return (
    <html lang="nl" className="scroll-smooth">
      <head>
        {/* Canonical URL */}
        <link rel="canonical" href="https://digitechsolutions.nl/" />
